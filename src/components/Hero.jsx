...
import { BallCanvas, ComputerCanvas } from "./index"
    ...
    return (
        <section className="relative w-full h-screen mx-auto">
            <div className="sm:px-16 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5">
                ...
                <div>
                    <h1 className="text-secondary lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2">Hi I'm <span className="text-pink">{hero.name}</span></h1>
